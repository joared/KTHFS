...
"""autogenerated by genpy from fs_msgs/ClassifiedBoundingBoxes.msg. Do not edit."""
import sys
...
class ClassifiedBoundingBoxes(genpy.Message):
  _md5sum = "c03e7499c2e5b938e301fea76459b092"
  _type = "fs_msgs/ClassifiedBoundingBoxes"
...
"""
  ...
  _slot_types = ['std_msgs/Header','std_msgs/Header','fs_msgs/ClassifiedBoundingBox[]']
  ...
  def __init__(self, *args, **kwds):
    ...
    """
    if args or kwds:
      super(ClassifiedBoundingBoxes, self).__init__(*args, **kwds)
  ...
  def deserialize(self, str):
    ...
    try:
      ...
      for i in range(0, length):
        val1 = fs_msgs.msg.ClassifiedBoundingBox()
        start = end
        end += 4
        (length,) = _struct_I.unpack(str[start:end])
        start = end
