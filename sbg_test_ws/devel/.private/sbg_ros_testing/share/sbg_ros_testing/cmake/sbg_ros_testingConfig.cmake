...
if(NOT " " STREQUAL " ")
  ...
  foreach(idir ${_include_dirs})
    ...
    elseif("${idir} " STREQUAL "include ")
      ...
      message(FATAL_ERROR "Project 'sbg_ros_testing' specifies '${idir}' as an include dir, which is not found.  It does neither exist as an absolute directory nor in '/home/jack/KTHFS/sbg_test_ws/src/sbg_ros_testing/${idir}'.  ${_report}")
    endif()
...
foreach(library ${libraries})
  ...
  elseif(IS_ABSOLUTE ${library})
    ...
    foreach(path /home/jack/KTHFS/sbg_test_ws/devel/.private/sbg_ros_testing/lib;/home/jack/KTHFS/sbg_test_ws/devel/lib;/home/jack/kth_fs_ws/devel/lib;/opt/ros/melodic/lib)
